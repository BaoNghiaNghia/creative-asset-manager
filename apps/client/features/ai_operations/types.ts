...
export type PipelineSnapshot = {
  ...
  recent_assets: Page<{ asset_id: string | null; filename: string; mime_type?: string | null; thumbnail_url?: string | null; source_type?: string | null; source_username?: string | null; state: string; stage_statuses: Record<string, string>; updated_at: string; error_code: string | null }>;
};
