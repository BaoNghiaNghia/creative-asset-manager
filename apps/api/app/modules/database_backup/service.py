...
class DatabaseBackupService:
    """Create and verify a custom PostgreSQL dump without remote mutation.

    DB-BACKUP-1 intentionally stops after local verification. DB-BACKUP-2 will
    own upload and call cleanup_verified_backup only after remote verification.
    """
