...
BUILTIN_PROMPTS = {
    "daily_gemini_processing": """Process today's Gemini working workbook. Use the sheet \"Báo cáo sử dụng NVL trong ca\" as operational evidence and reconcile its daily material data into the relevant inventory/location sheets where those materials belong. Discover relationships from workbook structure, material/location catalogs and exact evidence rather than fixed sheet positions or columns. Preserve independent quantity dimensions and do not invent package, recipe or BOM conversions. Do not map a material by row number alone. Stage only evidence-backed edits, preserve formulas and structure, and report ambiguity instead of guessing. The goal is that today's Gemini workbook becomes the verified end-of-day inventory result.""",
