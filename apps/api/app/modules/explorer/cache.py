...
thumbnail_cache = AsyncSingleFlightTTLCache(
    ByteSizeTTLCache[ThumbnailKey, CachedThumbnail](
        # Keep the server-side thumbnail working set bounded. 96 MiB keeps
        # a large active folder warm while preserving RAM headroom on the
        # production VPS for preview conversion and transient decoding.
        max_entries=2048,
